                                    ...
                                    <form onSubmit={this.handleSubmit}>
										<div className="form-group clearfix">
                                            <div className="col-sm-6">
                                                ...
                                                <input type="text" name="posisi" readOnly value={this.state.posisi} name="posisi" onChange={this.handleChange} required placeholder="Eg: Supervisor" className="form-control" />
										    </div>
                                        </div>
                                        <div className="form-group clearfix">
                                            <div className="col-sm-6">
