...
function LeftSidebar() {
  return (
    ...
    <div class="left side-menu">
        ...
        <div class="sidebar sidebar-inner slimscrollleft">
            {/* <!--- Divider --> */}
            <div id="sidebar-menu">
                ...
                <ul>
                    ...
                    <li class="has_sub">
                        <NavLink to="/absensi" class="waves-effect"><i class="ti-home"> </i> <span> Karyawan </span> <span class="menu-arrow"></span></NavLink>
                     </li>

                    <li className="has_sub treeview">
                        <a href="#" className="waves-effect"><i className="ti-alarm-clock"></i> <span> Cuti</span> <span className="menu-arrow"></span></a>
                        <ul className="list-unstyled treeview-menu">
                            <li><NavLink to="/cuti"> Form Pengajuan </NavLink></li>
                            <li><NavLink to="/list"> Daftar Pengajuan </NavLink></li>
                            <li><a href="ui-panels.html">Daftar Disetujui</a></li>
                        </ul>
                    </li>
